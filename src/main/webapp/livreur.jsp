                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="newchefServlet" method="post">
                                                ...
                                                <input type="hidden" name="status" id="hiddenStatus_${order.id}" value="${order.status}" />
                                                <button type="submit" onclick="document.getElementById('hiddenStatus_${order.id}').value = document.getElementById('status_${order.id}').value;">Update</button>
                                            </form>
                                        </td>
                                    </tr>
                                </c:forEach>
