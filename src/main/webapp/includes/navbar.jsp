...
int userRole = (user != null) ? user.getRole() : 0; // Assuming 0 is default role

// Define variables for menu items to display based on user role
boolean client = (userRole == 1 || userRole == 0); // Display cart for role 1
boolean chef = (userRole == 2); // Display order for roles 1 and 2
boolean livreur = (userRole == 3); // Display checkout for roles 1 and 2
%>
<header>
							...
							<ul>
								...
								<li><span class="opener"></span> <a
									...
									<ul class="dropdown-content">
										...
										<%
										// Assuming you have boolean variables 'client', 'chef', and 'livreur' indicating the user roles
										if (client) {
										%>
										<li><a href="AddToCart">Cart</a></li>
										<li><a href="checkout">Checkout</a></li>
										<li><a href="Orderservlet">Order</a></li>
										<%
										} else if (chef) {
										%>
										<li><a href="chefServlet">Work</a></li>
										<%
										} else if (livreur) {
										%>
										<li><a href="livreurServlet">Livreur</a></li>
										<%
										}
										%>
									</ul></li>
